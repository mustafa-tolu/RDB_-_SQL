...
ON UPDATE NO ACTION
ON DELETE NO ACTION  -- Ana tabloda deðiþiklik yapýldýðýnda ne olacaðý
...
Alter table Person.Person add constraint FK_PersonID_check Check (SSN > 9999999999 and SSN <= 99999999999)
